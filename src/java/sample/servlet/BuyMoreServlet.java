 ...
 * @author Admin
 */
@WebServlet(name = "BuyMoreServlet", urlPatterns = {"/BuyMoreServlet"})
public class BuyMoreServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Clothes> watch = new ArrayList<>();
            ...
            try {
                ...
                Logger.getLogger(BuyMoreServlet.class.getName()).log(Level.SEVERE, null, ex);
            }
